   ...
   <title>TIRRKUYY❤</title>
    <style>
        * {
        ...
        body {
        height: 100vh;
        background: linear-gradient(135deg, #8bd3dd, #31828d);
        }
        html {
        font-size: 16px;
        }
...
<body>
   ...
   <div class="wrapper-custom">
       <div class="container-custom">
           <button class="button-option-custom"></button>
           <button class="button-option-custom"></button>
           <button class="button-option-custom"></button>
           <button class="button-option-custom"></button>
           <button class="button-option-custom"></button>
   ...
   <!-- <script src="tanyakan.js"></script> -->
    <!-- Script -->
    <script>
        let btnRef = document.querySelectorAll(".button-option-custom");
