...
<html lang="en">
  ...
  <body>
    <button hidden id="myButton" onclick="sendMessage()"></button>
    <section class="section">
        <div class="jumbotron jumbotron-fluid bg-dark text-white text-center">
            <div class="container">
                <img src="img/profil.jpg" class="img-profil" alt="">
                <p id="typing-text"></p>
            </div>
          </div>
    </section>
    <section class="section-dua">
        <div class="container">
           <a href="https://www.linkedin.com/in/202038-farhan-enre/">
           ...
           <a href="https://tirr.default.my.id/">
            <div class="card shadow">
                <div class="card-body d-flex align-items-center">
                    <span class="icon"><i class="fa-solid fa-globe"></i></span>
                    <span class="ml-2">Tirrkuyy</span>
                </div>
            </div>
           </a>
           <a href="https://haanid.site/">
            <div class="card shadow">
                <div class="card-body d-flex align-items-center">
                    <span class="icon"><i class="fa-solid fa-globe"></i></span>
                    <span class="ml-2">Haanid.Site</span>
                </div>
            </div>
           </a>
           <a href="https://food.grab.com/id/id/restaurant/kedai-farhan-abadi-sudiang-raya-delivery/6-C2UEKALUAY5BFE?exp_src=share&itemID=IDITE2023111106385774340">
            <div class="card shadow">
                <div class="card-body d-flex align-items-center">
                    <span class="icon"><i class="fa-solid fa-link"></i></span>
                    <span class="ml-2">GrabFood Indonesia</span>
                </div>
            </div>
           </a>
           <a href="https://gofood.link/a/KcjQtrs">
            <div class="card shadow">
                <div class="card-body d-flex align-items-center">
                    <span class="icon"><i class="fa-solid fa-link"></i></span>
                    <span class="ml-2">GoFood Indonesia</span>
                </div>
            </div>
           </a>
        </div>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                   <a href="#">
                        <img class="d-block w-100 img-banner" src="img/banner/BANNER3.png" alt="First slide">
                   </a>
                </div>
                <div class="carousel-item ">
                   <a href="#">
                        <img class="d-block w-100 img-banner" src="img/banner/BANNER2.png" alt="First slide">
                   </a>
                </div>
                <div class="carousel-item ">
                   <a href="#">
                        <img class="d-block w-100 img-banner" src="img/banner/BANNER1.png" alt="First slide">
                   </a>
                </div>
            </div>
            ...
            <footer class="footer">
                <span><center>Made In Haanid</span>
            </footer>
    <!-- Optional JavaScript -->
    ...
    <!-- <script src="hati.js"></script> -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const text = "Hai, Perkenalkan Nama Saya Muhammad Farhan Enre";
            let index = 0;
            ...
            function type() {
                ...
                if (index <= text.length) {
                    setTimeout(type, 50); // Waktu delay antar karakter (ms)
                }
            }
