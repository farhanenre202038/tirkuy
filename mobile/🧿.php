...
<html lang="en">
  ...
  <body>
   ...
   <?php require('template/navbar.php'); ?>
    ...
    <div class="container">
        <div class="stats">
            <p id="heads-count">Haan: 0</p>
            <p id="tails-count">Tiir: 0</p>
        </div>
        <div class="coin" id="coin">
            <div class="heads">
                <img src="img/haan.svg">
            </div>
            <div class="tails">
                <img src="img/tiir.svg">
            </div>
        </div>
        <div class="buttons">
...
function updateStats(){
    document.querySelector("#heads-count").textContent = `Haan: ${heads}`;
    document.querySelector("#tails-count").textContent = `Tiir: ${tails}`;
}
